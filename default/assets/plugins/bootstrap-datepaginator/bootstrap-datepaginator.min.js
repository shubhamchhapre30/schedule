! function(t, e, i, s) {
    ...
    o.defaults = {
        ...
        squareEdges: !1,
        text: "dddd<br/>Do, MMMM YYYY",
        textSelected: "dddd<br/>Do, MMMM YYYY",
        width: 0,
        startDate: new Date(-864e13),
        startDateFormat: "YYYY-MM-DD",
        endDate: new Date(864e13),
        ...
        _back: function() {
            this._setSelectedDate(this.options.selectedDate.clone().subtract("day", 7)), this._render()
        },
        _forward: function() {
            this._setSelectedDate(this.options.selectedDate.clone().add("day", 7)), this._render()
        },
        _select: function(t) {
        ...
        _template: {
            list: '<ul class="pagination" style="margin: 0px !important;"></ul>',
            listItem: "<li></li>",
            navItem: '<a href="#" class="dp-nav" style="border-radius: 0px;"></a>',
