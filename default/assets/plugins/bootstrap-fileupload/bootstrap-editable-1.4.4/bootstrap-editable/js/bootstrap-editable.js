	...
	Datepicker.prototype = {
		...
		place: function(){
			...
			var height = this.component ? this.component.outerHeight(true) : this.element.outerHeight(true);
                    ...
                    if(this.element.attr('id')=="datepicker_end_by" || this.element.attr('id')=="task_due_date_div" || this.element.attr('class') == "input-append date date-picker dependent_task_due_date_picker")
                        {
                            this.picker.css({
				top: offset.top - 250,
				left: offset.left,
