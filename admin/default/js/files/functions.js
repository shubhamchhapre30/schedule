$(function() {
	...
	$('a.settings_menu').click(function () {
	   $('.leftUser').hide();
	   $('#left_settings').slideToggle(200);
		
	});
	
	$('a.model').click(function () {
	   $('.leftUser').hide();
	   $('#model_setting').slideToggle(200);
	...
	$('a.model').mouseenter(function () {
		 $('.leftUser').hide();							  	
		$('#model_setting').show(200);
	});
	$('#model_setting').mouseleave(function () {
		$('$model_setting').hide(200);
	});
	$('#modeldiv').mouseleave(function () {
		$('#model_setting').hide(200);
	});
	
	
	$('a.newsletter').mouseenter(function () {
		 $('.leftUser').hide();							  	
		$('#newsletter').show(200);
	});
	...
	$('a.vehicle').mouseenter(function () {
		 $('.leftUser').hide();							  	
		$('#vehicle').show(200);
	});
	$('#vehicle').mouseleave(function () {
		$('#vehicle').hide(200);
	});
	$('#vehiclediv').mouseleave(function () {
		$('#vehicle').hide(200);
	});
	
	
	
	$('a.leftUserDrop').mouseenter(function () {
											 	
		$('#leftUser').show(200);
	});
	$('#leftUser').mouseleave(function () {
		$('.leftUser2').hide(200);
	});
	$('#leftuserdiv').mouseleave(function () {
		$('#leftUser').hide(200);
	});
	
	
	 $('a.settings_menu').mouseenter(function () {
$('.leftUser').hide();
		$('#left_settings').show(200);
	});
	$('#left_settings').mouseleave(function () {
		$('#left_settings').hide(200);
	});
	$('#settings_menudiv').mouseleave(function () {
		$('#left_settings').hide(200);
	});
	
	$('a.master_menu').mouseenter(function () {
$('.leftUser').hide();
		$('#left_master').show(200);
	});
	$('#left_master').mouseleave(function () {
		$('#left_master').hide(200);
	});
	$('#master_menudiv').mouseleave(function () {
		$('#left_master').hide(200);
	});
