...
class TCPDF {
	...
	public function Header() {
        ...
        if ($this->getRTL()) {
            ...
            $this->SetX($this->original_lMargin);
            //$footer_data=$headerdata['logo'];
            //$footer_data="Report for ".$cmp_name;
           // $this->Cell(0, 5, $this->getAliasRightShift().$footer_data, 'T', 0, 'R');
            //$this->Cell(0, 15, $this->getAliasRightShift().$pagenumtxt, 'T', 0, 'R');
            $footer_data="Created on : ".$date;
            $this->Cell(0, 17, $this->getAliasRightShift().$footer_data, 'T', 0, 'R');
            $this->Cell(0, 27, $this->getAliasRightShift().$pagenumtxt, 'T', 0, 'R');
