				...
				<div class="row-fluid">
					<div class="span12">
						<div class="portlet box green">
								...
								echo form_open('MetaSetting/index',$attributes);
			  ?>
										<?php  
										if($error != "") {
									...
									?>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" class="m-wrap medium" name="title" id="title" value="<?php echo $title; ?>"/>
													</div>
												</div>
												<div class="control-group">
													<label class="control-label">Meta Keyword</label>
													<div class="controls">
														<input type="text" class="m-wrap medium"  name="meta_keyword" id="meta_keyword" value="<?php echo $meta_keyword; ?>">
													</div>
												</div>
												<div class="control-group">
													<label class="control-label">Meta Description <span class="required"></span></label>
													<div class="controls">
														<textarea name="meta_description" class="m-wrap span6" rows="4" id="meta_description"><?php echo $meta_description; ?></textarea>
													</div>
												</div>
												...
												<div class="form-actions">
													...
													<button class="btn green" type="submit"><?php echo ($meta_setting_id!='')?'Update':'Submit' ?></button>
