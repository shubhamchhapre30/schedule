				...
				<div class="row-fluid">
					<div class="span12">
						<div class="portlet box blue">
										...
										echo form_open_multipart('Demo/addCountry', $attributes); ?>
										<?php  
										if($error != "") {
									...
									<div class="alert alert-success hide">
										...
										Your form validation is successful!
												...
												<div class="control-group">
													...
													<div class="controls">
														<input type="text" class="m-wrap medium"  name="country_name" id="country_name" placeholder="" value="<?php echo $country_name; ?>">
											...
											<div class="control-group">
												...
												<div class="form-actions">
													...
													<button class="btn blue" type="submit"><i class="icon-ok"></i> <?php echo ($country_id!='')?'Update':'Submit' ?></button>
													<!-- 
