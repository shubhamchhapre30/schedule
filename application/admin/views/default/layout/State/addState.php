			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<h3 class="page-title">
							<?php echo ($state_id=="")?'Add':'Edit'; ?> State					
						</h3>
					...
					<div class="span12">
						<div class="portlet box blue">
										<div class="portlet-title">
											<div class="caption"><i class="icon-State"></i><?php echo ($state_id=="")?'Add':'Edit'; ?> State </div>
											<!-- <div class="tools">
										...
										echo form_open_multipart('State/addState', $attributes); ?>
										<?php  
										if($error != "") {
									...
									<div class="alert alert-success hide">
										...
										Your form validation is successful!
											...
											<div class="control-group">
												<label class="control-label">Province Name<span class="required">*</span></label>
												<div class="controls">
													<input type="text" class="m-wrap medium alpha-only"  name="state_name" id="state_name" placeholder="" value="<?php echo $state_name; ?>">
											...
											<div class="control-group">
												...
												<div class="form-actions">
													...
													<button class="btn blue" type="submit"><?php echo ($state_id!='')?'Update':'Submit' ?></button>
													
													<?php if($redirect_page == 'listState')
														{?>
														<input type="button" name="Cancel" value="Cancel" class="btn" onClick="location.href='<?php echo base_url(); ?>State/<?php echo $redirect_page.'/'.$limit.'/'.$offset?>'" />
														<?php }else
														{?>
														<input type="button" name="Cancel" value="Cancel" class="btn" onClick="location.href='<?php echo base_url(); ?>State/<?php echo $redirect_page.'/'.$limit.'/'.$option.'/'.$keyword.'/'.$sort_on.'/'.$sort_type.'/'.$offset?>'" />
