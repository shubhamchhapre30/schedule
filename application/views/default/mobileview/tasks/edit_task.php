...
if($msg =='insert'){ $message = "Project task inserted successfully";}
if($msg =='update'){ $message = "Project task updated successfully";}
...
<script type="text/javascript">
	$(document).ready(function(){
 	$('#task_due_date').datepicker({
		...
		//$('#task_time_estimate_hour').inputmask({"mask": "9", "repeat": 3, "greedy": false});
		//$('#task_time_estimate_min').inputmask({"mask": "9", "repeat": 2, "greedy": false});
				 ...
				 <div class="border-bx">
				  <div class="horizontal-form">
						...
						<?php   $attributes = array('name'=>'frm_addtask', 'id' => 'frm_addtask');
								echo form_open('task/add_task/'.base64_encode($project_id), $attributes); 
						?>
							<div class="row">
								<div class="col-md-12">
									...
									<div class="control-group">
										...
										<div class="controls">
											<!--<input type="text" placeholder="" class="m-wrap fullwd " />-->
											<select class="span11 m-wrap fullwd" name="section_id" id="sectiop_id" tabindex="1">
									 ...
									 <div class="control-group">
									  <label class="control-label">Time Estimate : </label> 
										 <div class="controls">
											 <!--
											 <input type="text" id="task_time_estimate_hour" name="task_time_estimate_hour" placeholder="Hours" value="<?php echo $task_time_estimate_hour;?>" class="m-wrap margin-bottom-10 " />
									...
									<div class="control-group">
										...
										<div id="loc_due_dt" class="controls-left">
											...
											<input name="hdn_locked_due_date" id="hdn_locked_due_date" value="<?php echo $locked_due_date;?>" type="hidden" >
							  ...
							  <div class="control-group">
								<div class="controls text-center margin-top-20">
									...
									<input type="hidden" id="task_owner_id" name="task_owner_id" value="<?php echo $task_owner_id;?>" />
									<input type="hidden" name="redirect_page" id="redirect_page" value="<?php echo isset($redirect_page)?$redirect_page:'from_kanban'; ?>" />
									<input type="hidden" id="general_project_id" name="general_project_id" value="<?php echo $project_id;?>" />
...
<script type="text/javascript">
	$(document).ready(function(){		
		//$("#task_title").limiter(<?php //echo CMT_TEXT_SIZE;?>,// $('#ch14'));	
		//$("#task_description").limiter(10000, $('#ch13'));	
				...
				if(validate(val) == true )   ///&& (!$('#manual_reason').hasClass('in'))
				{
		              ...
		              var splitval_clone = val.split(":");
						...
						if(val.length>=5 && splitval.length!=2){
							...
							$("input[name='task_time_estimate']").val('');
							//$("#manual_reason").css('display','none');
