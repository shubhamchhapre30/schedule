                	...
                	<?php if($task_thisweek!='0'){
                		...
                		foreach ($task_thisweek as $t) {
							...
							if($t["day"] =='Monday'){
								...
								$estimate_minutes = ($t["task_time"] % 60);//$prog = $user_time->MON_hours;
							...
							if($t["day"] =='Tuesday'){
								...
								$estimate_hours = intval($t["task_time"]/60);
								//$estimate_minutes = $t["task_time"] - ($estimate_hours * 60);
								$estimate_minutes = ($t["task_time"] % 60);//$prog = $user_time->TUE_hours;
							...
							if($t["day"] =='Wednesday'){
								...
								$estimate_hours = intval($t["task_time"]/60);
								//$estimate_minutes = $t["task_time"] - ($estimate_hours * 60);
								$estimate_minutes = ($t["task_time"] % 60);//$prog = $user_time->WED_hours;
							...
							if($t["day"] =='Thursday'){
								...
								$estimate_hours = intval($t["task_time"]/60);
								//$estimate_minutes = $t["task_time"] - ($estimate_hours * 60);
								$estimate_minutes = ($t["task_time"] % 60);//$prog = $user_time->THU_hours;
							...
							if($t["day"] =='Friday'){
								...
								$estimate_hours = intval($t["task_time"]/60);
								//$estimate_minutes = $t["task_time"] - ($estimate_hours * 60);
								$estimate_minutes = ($t["task_time"] % 60);//$prog = $user_time->FRI_hours;
							...
							if($t["day"] =='Saturday'){
								...
								$estimate_hours = intval($t["task_time"]/60);
								//$estimate_minutes = $t["task_time"] - ($estimate_hours * 60);
								$estimate_minutes = ($t["task_time"] % 60);//$prog = $user_time->SAT_hours;
							...
							if($t["day"] =='Sunday'){
								...
								$estimate_hours = intval($t["task_time"]/60);
								//$estimate_minutes = $t["task_time"] - ($estimate_hours * 60);
								$estimate_minutes = ($t["task_time"] % 60);//$prog = $user_time->SUN_hours;
