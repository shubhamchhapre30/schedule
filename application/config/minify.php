...
$config['assets_dir'] = 'default/assets';
...
$config['assets_dir_js'] = 'default/assets/js';     
// where to look for css files (default value: 'assets/css')
$config['css_dir'] = 'default/assets/css';
// where to look for js files (default value: 'assets/js')
$config['js_dir'] = 'default/assets/js';
